...
const ShopDashboard = () => {
  ...
  return (
    <section className="w-full min-h-[78vh] p-5 sm:p-8 ">
      <div className="flex flex-col gap-4 sm:gap-6 rounded-3xl p-5 sm:p-8 border border-gray-200 bg-white shadow-[0_16px_60px_rgba(15,23,42,0.08)]">
        <div>
        ...
        <div className="rounded-2xl border border-dashed border-gray-300 p-4 sm:p-6 bg-white">
          ...
          <div className="mt-4 flex justify-start gap-3">
            ...
            <Link
              to={`/shop/${seller?._id}`}
              className="inline-flex items-center justify-center rounded-xl bg-black px-4 py-2 text-sm font-semibold text-white hover:bg-red-700 transition"
            >
              Go to Shop
            </Link>
          </div>
